...
/**
 * RegisterPage — split-screen auth layout with brand panel (left) and form (right).
 * Owner (in team repo): @Segn11 — NOT @Capechusami.
 * This file exists in the local preview only. Do NOT copy it to the team repo.
 */
  ...
  return (
    <main className="flex min-h-screen w-full bg-white font-sans">
      ...
      <section className="relative flex w-full flex-col items-center justify-center p-8 lg:w-1/2">
        ...
        {/* Footer */}
        <p className="absolute bottom-6 text-sm text-ink-700">
          Need help?{" "}
